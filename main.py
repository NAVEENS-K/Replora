...
def benchmark(examples):
    ...
    print("=" * 64)
    for k, label in [("test_cases", "Test cases"), ("average_quality_score", "Quality Score"), ("average_risk_score", "Risk Score"), ("average_correctness", "Correctness"), ("average_relevance", "Relevance"), ("average_completeness", "Completeness"), ("average_groundedness", "Groundedness"), ("average_tone", "Tone"), ("high_risk_responses", "High-risk replies")]:
